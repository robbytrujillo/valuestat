    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card p-4 shadow-md" style="border-radius: 5%;">
                <h2 class="text-center mt-3 mb-3"><span style="color: #50A745">Edit Data Mapel</span></h2>
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="kode_mapel">Kode Mapel</label>
                        <input type="text" name="kode_mapel" class="form-control rounded-pill" value="<?= $mapel['kode_mapel'] ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="nama_mapel">Nama Mapel</label>
                        <input type="text" name="nama_mapel" class="form-control rounded-pill" value="<?= $mapel['nama_mapel'] ?>" required>
                    </div>
