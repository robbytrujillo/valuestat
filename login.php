...
<head>
  <meta charset="UTF-8">
  <title>Login | Statistik Nilai Santri</title>
      ...
      <div class="col-md-6">
        <div class="card p-4 shadow">
          <div class="text-center">
            <img src="assets/images/valuestat-logo.png" alt="Logo" class="logo mb-3" style="width: 180px; margin-left: 0%; margin-top: 3%">
          ...
          <form action="login-proses.php" method="POST">
            ...
            <div class="form-group">
              <label for="role" class="text-dark">Login sebagai:</label>
